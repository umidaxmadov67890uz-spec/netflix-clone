  ...
  return (
    <div>
      {userFavoritesData?.length > 0 ? (
        <div className="container mx-auto xl:px-15 pt-20 mb-20">
          <div className="flex flex-wrap justify-between sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-y-10 gap-x-6">
