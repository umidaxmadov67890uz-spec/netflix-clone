    ...
    <div className="flex items-start justify-start gap-x-5">
      ...
      <div>
        ...
        <div className="flex items-center gap-x-2 my-7">
          <button onClick={play} className="bg-white py-1 px-4 rounded-sm flex items-center gap-x-1 font-bold text-xl cursor-pointer hover:scale-105 transition-all duration-300">
            <IoMdPlay />
            watch
          </button>
